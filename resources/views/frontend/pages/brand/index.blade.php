...
@section('content')
    ...
    <div style="margin: 0 40px;">
        <div class="my-breadcrumb" style="z-index: 10;">
            ...
            <a href="#"> <i class="fa fa-angle-right"></i> {{$brandss->br_name}}</a>
        </div>
        <div class="line-rating"></div>
        <div class="row">
        <div class="col-sm-12 col-md-2">
                  <div class="sidebar" style="margin: 40px 0;">
                  <p style="font-size: 16px; font-weight: 700;">LOẠI SẢN PHẨM</p>
                  <ul class="nav flex-column nav-pills">
                        @foreach($typeProducts as $count => $typePro)
                            <li class="item-link myset">
                                <a class="nav-link"  
                                   href="{{ route('get.list.product.type',[$typePro->tp_slug, $brandss->id, $typePro->id]) }}" 
        ...
        <div class="col-sm-12 col-md-10">
            <div class="product-site">
                ...
                <h4 class="tab-content-item-sale__new" style="margin-top:20px; color: #ff6600">Sản phẩm của thương hiệu {{$brandss->br_name}}</h4>
