...
@section('content')
    ...
    <div style="margin: 0 40px;">
        <div class="my-breadcrumb" style="z-index: 10;">
            ...
            <a href="{{route('get.list.product',[$brandss->br_slug, $brandss->id])}}"> <i class="fa fa-angle-right"></i> {{ $brandss->br_name }}</a>
        ...
        <div class="col-sm-12 col-md-10" style="margin: 0 auto;">
            <div class="product-site">
                ...
                <h4 class="tab-content-item-sale__new" style="margin-top:20px; color: #ff6600">Sản phẩm thuộc {{$brandss->br_name}} -> {{$typePro->tp_name}}</h4>
